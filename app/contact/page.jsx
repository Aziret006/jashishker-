        ...
        <div className={s.container}>
          ...
          <div className={s.contactWrap}>
            <div className={s.contactMap}>
              ...
              <div >
                <iframe className={s.map} src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d93561.74256997774!2d74.50946009379832!3d42.87697130626171!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x389eb7dc91b3c881%3A0x492ebaf57cdee27d!2z0JHQuNGI0LrQtdC6!5e0!3m2!1sru!2skg!4v1718860444344!5m2!1sru!2skg" width="600" height="450" style={{ border: 0 }} allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
              </div>
            </div>
              ...
              <div className={s.contactList}>
                ...
                <div className={s.contactItem}>
                  ...
                  <div className={s.contactTitle}>
                    ...
                    <Link href=''>
                      <span className={FontManrope.className}>
                        enactuskyrgyzstan@gmail.com                      </span>
                    </Link>
                  </div>
                </div>
              </div>
