        ...
        <div className={s.container}>
          ...
          <div className={s.partnerContent}>
            ...
            <p className={FontManrope.className}>
              Данный проект реализуется при содействии Управления молодежной политики Министерства культуры, информации, спорта и молодежной политики Кыргызской Республики (МКИСМП). Управление МКИСМП является государственным органом исполнительной власти, осуществляющим функции по разработке и реализации государственной политики в сфере молодежной политики.
            </p>
            <div className={s.partnerContact}>
              <div className={s.contact}>
                <div className={s.icon}>
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                    <path d="M16 10C16 12.2091 14.2091 14 12 14C9.79086 14 8 12.2091 8 10C8 7.79086 9.79086 6 12 6C14.2091 6 16 7.79086 16 10Z" stroke="white" stroke-width="2" />
                    <path d="M20 10C20 14.4183 14 22 12 22C10 22 4 14.4183 4 10C4 5.58172 7.58172 2 12 2C16.4183 2 20 5.58172 20 10Z" stroke="white" stroke-width="2" />
                  </svg>                </div>
                <div className={s.contactTitle}>
                  <p class>Адрес:</p>
                  <Link href=''>
                    <span className={FontManrope.className}>
                      Пушкина 78, <br />720040 Бишкек, Кыргызстан
                    </span>
                  </Link>
                </div>
              </div>
              ...
              <div className={s.contact}>
                <div className={s.icon}>
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                    <path d="M12 23C18.0751 23 23 18.0751 23 12C23 5.92487 18.0751 1 12 1M12 23C5.92487 23 1 18.0751 1 12C1 5.92487 5.92487 1 12 1M12 23C14.2091 23 16 18.0751 16 12C16 5.92487 14.2091 1 12 1M12 23C9.79086 23 8 18.0751 8 12C8 5.92487 9.79086 1 12 1M2 8H22M2 15H22" stroke="white" stroke-width="2" stroke-linecap="round" />
                  </svg>                </div>
                <div className={s.contactTitle}>
