          ...
          <div className={s.flexinn}>
            ...
            <ul>
              ...
              <li>
                ...
                технологических возможностей производства создать продукт,
                который будет отличаться от других. Например, благодаря открытию
                нового источника сырья или разработке нового технического
                средства. Таким образом, предприниматель-новатор постоянно
                находиться в поиске новых возможностей.
              </li>
            </ul>
          </div>
