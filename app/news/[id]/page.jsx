        ...
        <div className={s.newsContend}>
          ...
          <div className={s.Cards}>
            <div className={s.SwiperCards}>
              ...
              <p>
                В рамках проекта «Молодежь за цифровизацию, лидерство и зеленые
                навыки», Энактас Кыргызстан объявляет конкурс на вакансию
                эксперта по реализации стратегий Требования и техническое
                задание по ссылке: Процедура подачи заявок и отбора: Всем
                соискателям, соответствующим квалификационным требованиям,
                предлагается отправить свои  заявки по следующему электронному
                адресу – enactuskyrgyzstan@gmail.com  до 20 мая  2024 года,
                до  17.00 часов, указав в теме письма «на эксперта по реализации
                стратегии хабов» Соискатели, включенные в список кандидатов на
                должность, будут приглашены на собеседование. Примечание:
                Вакансия будет закрыта, как только будет найден подходящий
                кандидат.
              </p>
              <span>
                <p>2.k views</p>
